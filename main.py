...
def gui():
    ...
    Button(text="=", width=data.button_width, height=data.button_height, font=data.font, bd=0, bg=data.color,
           command=button_equal_gpt).grid(row=5, column=4, pady=data.button_pady)
...
window = Tk()
window.title("calc")
window.iconbitmap("icons8-calculator-96.ico")
